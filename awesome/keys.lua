...
keys.desktopbuttons = gears.table.join(
   ...
   awful.button({ }, 2, function () awful.util.spawn(apps.launcher) end),
   awful.button({ }, 3, function () nexttheme() end),
...
keys.globalkeys = gears.table.join(
   ...
   awful.key({modkey}, "b",
      function()
         ...
         s.top_panel.panel.ontop = not s.top_panel.panel.ontop
         --awful.spawn(apps.launcher)
      end,
      {description = "application launcher", group = "launcher"}
   ),
   ...
   awful.key(
		...
		'l',
      function()
         local lock = 'awesome-client "awesome.emit_signal(\'module::lockscreen_show\')"'
